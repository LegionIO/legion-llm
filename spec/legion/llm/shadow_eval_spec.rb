...
RSpec.describe Legion::LLM::Quality::ShadowEval do
  ...
  describe '.enabled?' do
    ...
    it 'returns true when enabled' do
      Legion::Settings[:llm][:shadow] = { enabled: true }
