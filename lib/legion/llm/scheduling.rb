  ...
  module LLM
    module Scheduling
      ...
      class << self
        ...
        def enabled?
          Legion::Settings.dig(:llm, :scheduling, :enabled) == true
        end
        ...
        def peak_range
          raw = Legion::Settings.dig(:llm, :scheduling, :peak_hours_utc)
        ...
        def defer_intents
          raw = Legion::Settings.dig(:llm, :scheduling, :defer_intents)
