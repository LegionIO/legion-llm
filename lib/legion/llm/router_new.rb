  ...
  module LLM
    ...
    class Router
      ...
      def reject_no_candidates(evaluation_set:, model_pin:, **)
        ...
        has_op_cap_unknown     = policy_eligible.any? { |c| c.operation_state == :unknown || c.capability_state == :unknown }
        ...
        # Step 6 — invalid_request 400 (terminal settled-unknown capability).
        if all_scopes_complete && !fit_available && policy_eligible.any? { |c| c.capability_state == :unknown }
          return rejection_of(:invalid_request, 400,
