...
- Shared settings helpers now normalize string and symbol keys across response cache, API auth/defaults, metering, quality, guards, skills, config loaders, and audit encryption checks.
